@extends('layout')
@section('content')
<div class="px-2 bg-light "><marquee class="py-1" direction="left" onmouseover="this.stop()" onmouseout="this.start()" scrollamount="10" behavior="scroll">
    Selamat datang di website sekolah smpn 1 pujer bondowoso | Selamat datang di website sekolah smpn 1 pujer bondowoso | Selamat datang di website sekolah smpn 1 pujer bondowoso
    </marquee></div>
    <!-- Carousel Start -->
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown">SMP 1 PUJER BONDOWOSO</h1>
                                    <a href="" class="btn btn-primary py-sm-3 px-sm-4">Lihat Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    </div>
